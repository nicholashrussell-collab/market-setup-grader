...
values (
  ...
  false,
  100,
  'v8.9 week-ready tracked-symbol defaults. Paper execution starts disarmed.'
)
...
-- v8.9 tracked-symbol-only control panel. Safe to run multiple times.
update public.bot_control
set universe_label = 'Tracked Symbols',
    ...
    notes = coalesce(notes, 'v8.9 admin: tracked symbols list is the cloud bot watchlist.')
where id = 'main';
